...
On different browsers, the concert details, payment of concert tickets, merch and buttons may look slightly different. The website works on different screen sizes down to 320px width, therefore it works on almost all phones even small, old phones. On screens with a width of 600px and lower will have the elements slightly enlarged and stack in columns instead of rows for most sections. Some images will also have lower quality and file size based on the device's DPR (Device Pixel Ratio).
