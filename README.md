...
Try to select a location and verify that the date and time input changes
Try to change the date for Hong Kong
Verify that the time for Tokyo is 7.00pm local time while the rest is 8.00pm local time
Try to submit the form when the location is not selected and verify there is an error
Try to clear the date after selecting the location and submitting the form and verify there is an error

Payment detials form:
Go to the "Concert" and "Merch" page
Try to enter an email and verify there is an error when no '@' is entered
Try to enter the credit card information and verify there is an error when the input is not 16 numbers
Try to enter the CCV and verify there is an error when the input is not 3 numbers
Try to leave each input blank and verify there is an error telling you to input something

Cart:
Go to the "Merch" page
Try to click on the shopping bag and verify it scrolls to the cart
Try to add items to the cart by clicking add to cart for some merch items and verify it shows up in the cart with the name and the total price of all the items
Try to clear the cart and verify the items are gone

Filter merch tab:
Go to the "Merch" tab
Try to click each sub tab and verify that the items are categorised and those not in the category are hidden
